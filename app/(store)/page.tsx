          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-4">
            {topCategories.map((cat: any) => (
              <CategoryCard
                ...
                count={(cat as any)._count.products}
              />
            ))}
          </div>
        </section>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 pb-4">
        ...
        >
          ...
          <div className="relative max-w-lg">
            ...
            <p className="mt-2 text-base" style={{ color: 'var(--navy-100)' }}>
              Shop our sale collection and save big on hundreds of products.
            </p>
            <Link
              href="/products"
              className="mt-5 inline-flex items-center gap-2 rounded-lg px-6 py-2.5 text-sm font-bold transition-all"
              style={{ background: 'var(--accent)', color: '#fff' }}
            >
